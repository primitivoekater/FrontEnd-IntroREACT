...
import './style.css';
import  DrawerPictures from './assets/drawers.jpg'
import MichelePicture from '.assets/avatar-michelle.jpg'
function App() {
  return (
    <div className="content-wrapper">
    <article className="card">
      <div className="card__img">
        <img src={DrawerPictures} alt="furniture"/>
      </div>
      <div className="card__text-wrapper">
        ...
        <div className="card__footer-wrapper">
          <img src={MichelePicture} alt="author" className="author__img"/>
